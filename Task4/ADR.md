...
|       | Сервис экспорта ставок           |                                             | 2. Сервис экспорта ставок запрашивает в АБС актуальные ставки и отправляет их в виде файла на специальный e-mail системы партнёрского кол-центра. (F4) |
|       |                                  |                                             | 3. Система партнёрского кол-центра импортирует ставки из полученного по e-mail файла и кеширует их на своей стороне на сутки. (F5)                     |
